    ...
    <div class="flex flex-col h-full">
      ...
      <div class="flex-1">
        <div class="flex mt-4 h-full">
          ...
          <div class="ml-4 flex-1 overflow-y-scroll relative">
            <table v-if="status === 'success'" class="absolute table-fixed">
              <thead>
                <tr class="py-1">
                  <th class="w-[32px] playlist-header"></th>
                  <th class="min-w-[240px] playlist-header">タイトル</th>
                  <th class="w-[60px] playlist-header">時間</th>
                  <th class="w-[140px] playlist-header">配信日</th>
                  <th class="w-[200px] playlist-header">配信タイトル</th>
                </tr>
              </thead>
              <tbody class="">
                <tr
                ...
                >
                  ...
                  <td
                    class="text-nowrap text-ellipsis overflow-hidden w-[200px]"
                  >
                    {{ song.video.title }}
                  </td>
                </tr>
